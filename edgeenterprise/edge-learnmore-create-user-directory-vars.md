...
---
# Criar variáveis de diretório de dados do usuário do Microsoft Edge
...
>[!NOTE]
>Se não houver definição, o Microsoft Edge usa os caminhos de diretório padrão. Um usuário pode usar o sinalizador de linha de comando `--user-data-dir` para substituir o padrão.
