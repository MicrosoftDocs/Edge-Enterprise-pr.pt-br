...
2. Instale a versão mais recente do [Canal Microsoft Edge Dev](https://www.microsoftedgeinsider.com/download), 87.0.644.4 ou superior.
...
12. Feche a janela de  **Configurações**  para salvar e aplicar suas opções.
    ...
    :::image type="content" source="media/microsoft-edge-configure-kiosk-mode/ms-kiosk-mode--8-done.png" alt-text="Configurar o modo de quiosque com acesso atribuído" menu configurações habilitará somente as opções necessárias (por exemplo, Imprimir, Ajuda, Comentários e Ler em voz alta)
